...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/database_cleaner-0.4.1/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/database_cleaner-0.4.1/lib")
  ...
  @bundled_specs["database_cleaner"] = eval(File.read("#{dir}/specifications/database_cleaner-0.4.1.gemspec"))
  @bundled_specs["database_cleaner"].loaded_from = "#{dir}/specifications/database_cleaner-0.4.1.gemspec"
